...
export default function NewKampagnePage() {
  ...
  const tn = useTranslations("userMenu");
  ...
  return (
    <main className="min-h-screen" style={{ background: "var(--dnd-bg)" }}>
      ...
      <div className="mx-auto max-w-2xl px-4 md:px-6 py-10">
        <div className="mb-8">
          <h1 className="font-cinzel text-3xl font-bold" style={{ color: "var(--dnd-heading)" }}>{tf("createKampagneTitle")}</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className={labelStyle} style={{ color: "var(--dnd-label)" }}>{t("descLabel")}</label>
            <textarea
